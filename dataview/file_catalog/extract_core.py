                ...
                if uwi:
                    try:
                        _hn = _cap(engine, "cat_well", [{
                            ...
                            "WELL_TYPE":        _wv("WTYP", "WELLTYPE",
                                                    "WELL_TYPE"),
                            "WELL_STATUS":      _wv("WSTA", "WSTAT",
                                                    "STATUS"),
                            "WELL_PROFILE_TYPE": _wv("WPRF", "PROFILE",
                                                     "WCLASS"),
                            "BOTTOM_HOLE_LATITUDE":  _wnum("BHLA", "BHLAT"),
                            "BOTTOM_HOLE_LONGITUDE": _wnum("BHLO", "BHLON"),
                            "ACTIVE_IND":       "Y",
                            "ROW_QUALITY":      "FINAL",
                            "PPDM_GUID":        str(_uuid.uuid4()),
                            "ROW_CREATED_BY":   "DataWrangler",
