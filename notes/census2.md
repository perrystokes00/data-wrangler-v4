...
## What is actually in here — 977 file(s), 107 MB

_Plus 1,901 file(s) / 177 MB of version-control internals (.git), excluded — that is history, not code._
...
**275 artefact file(s), 12 MB** — caches, logs, reports, archives, zips. None of it is source. Removing it from the repo changes no behaviour, and it is the cheapest cut available.

---

## The python question — 423 python file(s)
- entry point(s): app_v4.py, selftest.py
- **145 LIVE** (reachable from an entry point)
- **153 SCRIPT** (standalone, has a __main__ guard)
- **125 ORPHAN** (unreachable, no __main__)
...
- **page_selected_documents.py**
    - `dataview\file_catalog\page_selected_documents.py` (14 KB) · LIVE
...
- **promote_ppdm.py**
    ...
    - `dataview\migration\promote_ppdm.py` (36 KB) · LIVE
- **purge_source.py**
...
- **run_h3.py**
    ...
    - `run_h3.py` (7 KB)
- **setup_database.py**
    - `dataview\core\setup_database.py` (30 KB) · LIVE
...
|---|---:|---:|
| `dataview\mapping\page_well_map.py` | 471 | 2 |
| `dataview\file_catalog\page_workbench.py` | 315 | 6 |
| `dataview\file_catalog\page_file_manager.py` | 180 | 1 |
| `dataview\import_data\page_pipeline.py` | 136 | 1 |
| `dataview\import_data\pipeline_run.py` | 113 | 11 |
| `dataview\import_data\promote.py` | 100 | 2 |
| `dataview\file_catalog\promote_catalog.py` | 90 | 7 |
| `dataview\import_data\page_dir_loader.py` | 86 | 6 |
| `dataview\file_catalog\doc_flow.py` | 77 | 3 |
| `dataview\import_data\exporters.py` | 75 | 2 |
| `dataview\file_catalog\page_file_browser.py` | 72 | 3 |
| `dataview\file_catalog\pdf_survey_catalog.py` | 71 | 8 |
| `dataview\core\fk.py` | 71 | 5 |
| `dataview\file_catalog\page_well_documents.py` | 71 | 1 |
| `dataview\file_catalog\file_summarizer.py` | 66 | 10 |
| `dataview\file_catalog\page_file_catalog.py` | 64 | 2 |
| `dataview\core\fk_entity.py` | 62 | 2 |
| `dataview\file_catalog\extract_core.py` | 60 | 5 |
| `dataview\file_catalog\worker_core.py` | 57 | 19 |
| `app_v4.py` | 55 | ENTRY |
| `dataview\file_catalog\dlis_catalog.py` | 55 | 6 |
| `dataview\file_catalog\catalog_rules.py` | 50 | 3 |
| `dataview\file_catalog\las_catalog.py` | 49 | 5 |
| `dataview\core\db_dialect.py` | 44 | 2 |
| `dataview\file_catalog\file_inventory.py` | 42 | 4 |
| `dataview\import_data\staging.py` | 42 | 5 |
| `dataview\file_catalog\inv_workbench.py` | 40 | 3 |
| `dataview\mapping\well_path.py` | 40 | 2 |
| `dataview\file_catalog\segy_catalog.py` | 39 | 7 |
...
| `dataview\db_explorer\page_db_explorer.py` | 36 | 1 |
| `dataview\migration\promote_ppdm.py` | 36 | 1 |
| `dataview\region_builder\page_region_builder.py` | 34 | 1 |
| `dataview\file_catalog\page_docshape.py` | 32 | 1 |
| `dataview\file_catalog\las_loader.py` | 32 | 2 |
| `dataview\file_catalog\file_viewer.py` | 32 | 6 |
| `dataview\file_catalog\pdf_db_loader.py` | 32 | 3 |
| `dataview\file_catalog\file_inventory_governance.py` | 32 | 4 |
| `dataview\file_catalog\enrich_file_headers.py` | 31 | 6 |
| `dataview\file_catalog\doc_assess.py` | 31 | 1 |
| `dataview\core\setup_database.py` | 30 | 2 |
| `dataview\core\validate.py` | 30 | 4 |
| `dataview\import_data\mapping.py` | 30 | 8 |
| `dataview\file_catalog\page_monitor.py` | 29 | 1 |
...
| `dataview\file_catalog\file_header_catalog.py` | 26 | 4 |
| `dataview\file_catalog\bcp_capture.py` | 26 | 5 |
| `dataview\file_catalog\page_file_workbench.py` | 25 | 2 |
...
| `dataview\file_catalog\file_header_store.py` | 22 | 4 |
| `selftest.py` | 22 | ENTRY |
| `dataview\core\fk_resolve_panel.py` | 21 | 1 |
| `dataview\mapping\dv_spatial_loader.py` | 21 | 3 |
| `dataview\core\db.py` | 21 | 16 |
| `dataview\file_catalog\vault_organizer.py` | 21 | 3 |
| `dataview\core\schema.py` | 20 | 8 |
| `dataview\reference_tables\user_rules.py` | 20 | 3 |
| `dataview\migration\page_migrate.py` | 19 | 1 |
| `dataview\file_catalog\extract_petro.py` | 18 | 2 |
| `dataview\file_catalog\page_extraction_inspector.py` | 18 | 1 |
| `dataview\core\demo_reset.py` | 18 | 2 |
| `dataview\import_data\load_diagnostics.py` | 17 | 1 |
| `dataview\reference_tables\page_standards_manager.py` | 17 | 1 |
| `dataview\file_catalog\promote_fk_review.py` | 17 | 1 |
| `dataview\file_catalog\promotion_lineage.py` | 17 | 4 |
| `dataview\mapping\h3_grids.py` | 16 | 3 |
| `dataview\migration\ppdm_model.py` | 16 | 3 |
...
| `dataview\migration\synonyms.py` | 14 | 4 |
| `dataview\file_catalog\page_selected_documents.py` | 14 | 1 |
| `dataview\migration\db_source.py` | 13 | 1 |
| `dataview\import_data\entity_map_seed.py` | 12 | 1 |
| `dataview\file_catalog\audit_log.py` | 12 | 4 |
| `dataview\file_catalog\work_queue.py` | 12 | 3 |
| `dataview\file_catalog\witsml_catalog.py` | 12 | 5 |
| `dataview\reference_tables\ref_seeder.py` | 12 | 1 |
| `dataview\core\ppdm_agent.py` | 12 | 1 |
...
| `dataview\import_data\load_router.py` | 10 | 1 |
...
| `dataview\migration\column_rules.py` | 9 | 1 |
| `dataview\mapping\geography_layers.py` | 9 | 2 |
| `dataview\file_catalog\survey_loader.py` | 9 | 1 |
| `dataview\file_catalog\catalog_docs.py` | 9 | 2 |
| `dataview\mapping\boem_geo.py` | 8 | 1 |
| `dataview\import_data\las_header_loader.py` | 8 | 4 |
| `dataview\file_catalog\inv_email.py` | 8 | 3 |
| `dataview\file_catalog\page_run.py` | 8 | 1 |
| `dataview\core\dw_utils.py` | 8 | 2 |
| `dataview\mapping\us_geo.py` | 8 | 1 |
| `dataview\file_catalog\csv_catalog.py` | 7 | 1 |
| `dataview\core\fk_catalog.py` | 7 | 3 |
| `dataview\file_catalog\crs_from_segy.py` | 7 | 2 |
| `docshape\packs\__init__.py` | 7 | 10 |
| `docshape\readers\las.py` | 7 | 2 |
| `dataview\core\catalog_dialect.py` | 7 | 1 |
| `dataview\file_catalog\current_run_scorecard.py` | 6 | 1 |
| `dataview\import_data\export_bcp.py` | 5 | 1 |
| `dataview\reference_tables\value_standardize.py` | 5 | 2 |
| `dataview\core\path_identity.py` | 5 | 4 |
| `dataview\db_explorer\page_schema_overview.py` | 5 | 1 |
| `dataview\file_catalog\inv_auth.py` | 4 | 3 |
| `dataview\core\hash_keys.py` | 4 | 2 |
| `dataview\region_builder\petroleum_regions.py` | 4 | 3 |
| `dataview\region_builder\state_regions.py` | 4 | 3 |
| `dataview\file_catalog\page_vault.py` | 4 | 1 |
| `dataview\core\fingerprint.py` | 4 | 5 |
| `docshape\readers\__init__.py` | 4 | 7 |
| `dataview\reference_tables\boem_status_codes.py` | 3 | 1 |
| `dataview\file_catalog\seis_filename_parser.py` | 3 | 5 |
| `dataview\reference_tables\boem_area_codes.py` | 3 | 1 |
| `docshape\__init__.py` | 1 | 3 |
| `dataview\core\db_pool.py` | 1 | 6 |
| `dataview\core\ui_helpers.py` | 1 | 4 |
...
| `dataview\db_explorer\__init__.py` | 0 | 1 |
| `dataview\region_builder\__init__.py` | 0 | 1 |
| `dataview\file_catalog\__init__.py` | 0 | 41 |
| `dataview\migration\__init__.py` | 0 | 2 |
